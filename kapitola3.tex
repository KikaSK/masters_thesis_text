...
on the figure \ref{img:25}. As the singularity is attached in the middle of the
bump function, we get the equality $r=\frac{\pi}{2k}$ and therefore
$\sqrt{h^{n+1}}=\frac{\pi}{2k} \implies k=\frac{\pi}{2\sqrt{h^{n+1}}}$.
The parameter $q$ is calculated from $C^1$ continuity requirement. 
