...
$$H_i : \vec{P_i P_{i+1}} \cdot (X-M_i) = 0.$$

The point $R_i^1$ is obtained by moving from the point $M_i$ in the direction 
perpendicular to both $H_i$ and $T_{S_1}(M_i^1)$ by the given edge length $e$:

$$R_i^1 = M_i + e \cdot \frac{\nabla{S_1}(M_1) \times \overrightarrow{P_{i} P_{i+1}}}{||\nabla{S_1}(M_1) \times \overrightarrow{P_i P_{i+1}}||}.$$