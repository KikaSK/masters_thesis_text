...
can be seen in the Figure~\ref{img:47}.
\begin{figure}[h!]
...
To obtain the results, a laptop with a 6-core AMD Ryzen 5 5600U was used.
...
\begin{tikzpicture} 
    \begin{axis}[ 
        ...
        xlabel={Length of the edge of the triangle},
        xmin=0, xmax=1,
        ymin=0.1, ymax=250,
...
\end{semilogyaxis}
\end{tikzpicture}
\caption[The dependence of the runtime on the input edge length for the unit sphere (logarithmic scale)]
{The dependence of the runtime on the input edge length for the unit sphere (logarithmic scale)}        
\label{graph2}
\end{figure}

    As the edge size does not fully capture the size of the mesh,
    we provide the graphs of dependence of the runtime of the 
    the algorithm from the number of triangles in the mesh.
    The dependence is displayed on the Graph~\ref{graph3}.
    The dependence with logarithmic scale is displayed on the Graph~\ref{graph4}.
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            \begin{axis}[ 
                ylabel={Runtime (in seconds)},
                xlabel={Number of generated triangles},
                xmin=0, xmax=3500,
                ymin=0, ymax=250,
        ...
        (3144,205.438933)
            ...
            \end{axis}
            \end{tikzpicture}
    \caption[The dependence of the runtime on the number of generated triangles]
    {The dependence of the runtime on the number of generated triangles}        
    \label{graph3}
        \end{figure}    
\begin{figure}
    \centering
...
(3144,205438.933)
    ...
    \end{semilogyaxis}
    \end{tikzpicture}
    \caption[The dependence of the runtime on the number of generated triangles (logarithmic scale)]
    {The dependence of the runtime on the number of generated triangles (logarithmic scale)}        
    \label{graph4}
\end{figure}
One can see that the brute-force algorithm beats the optimized implementation
