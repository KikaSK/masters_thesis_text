\chapter{Mathematical model of proposed triangulation}
\label{chap2}
...
We calculate the edge length for the given constant of detail $k_d$ as $\frac{r_c}{k_d}$
...
The resulting mesh with four layers is displayed in the
