...
\begin{figure}
    ...
    {$A_{n--}$ singularities. For more, see \cite{morris2003client}.}
    %id obrazku, pomocou ktoreho sa budeme na obrazok odvolavat
    \label{img:4}
\end{figure}
...
\begin{figure}
    ...
    {$D_{n+-}$ singularities. For more, see \cite{morris2003client}.}
    %id obrazku, pomocou ktoreho sa budeme na obrazok odvolavat
    \label{img:7}
\end{figure}
...
\begin{figure}
    ...
    {$E_n$ singularities. For more, see \cite{morris2003client}.}
    %id obrazku, pomocou ktoreho sa budeme na obrazok odvolavat
    \label{img:12}
\end{figure}
...
on the Figure~\ref{img:A5uniform}.  
...
\begin{itemize}
    \item 1st category singularities $-$ displayed on the Figure~\ref{img:42}:
    \begin{itemize}
        \item $A_{n--}$,
        \item $A_{n+-}$,
    ...
    \begin{figure}
        ...
        {1st category singularities. For more, see \cite{morris2003client}.}
        %id obrazku, pomocou ktoreho sa budeme na obrazok odvolavat
        \label{img:42}
    \end{figure}
    \item 2nd category singularities $-$ displayed on the Figure~\ref{img:43}:
    \begin{itemize}
    ...
    \begin{figure}
        ...
        {2nd category singularities. For more, see \cite{morris2003client}.}
        %id obrazku, pomocou ktoreho sa budeme na obrazok odvolavat
        \label{img:43}
    \end{figure}
\end{itemize}
...
\subsubsection*{Implicit equation of the function $B_{\cos}$}
...
\begin{figure}
    ...
    \label{img:24}
\end{figure}
We use the following equations of the surfaces to model the function $B_{\cos}$:
...
constants of the function $B_{\cos}$ to connect $C^1$ smoothly to the given
singularity.
